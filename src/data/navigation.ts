...
export const RULES_PAGE: PageLink = {
  number: "200",
  label: "RULES",
  href: `${base}rules`,
};
export const STANDINGS_PAGE: PageLink = {
  number: "300",
  label: "STANDINGS",
  href: `${base}standings`,
};
export const HEAD_TO_HEAD_PAGE: PageLink = {
  number: "301",
  label: "HEAD TO HEAD - 1ST HALF",
  href: `${base}standings/head-to-head`,
};
export const HEAD_TO_HEAD_2ND_PAGE: PageLink = {
  number: "302",
  label: "HEAD TO HEAD - 2ND HALF",
  href: `${base}standings/head-to-head-2nd`,
};
export const INITIAL_DRAFT_PAGE: PageLink = {
  number: "310",
  label: "INITIAL DRAFT",
  href: `${base}standings/draft`,
};
export const MIDSEASON_DRAFT_PAGE: PageLink = {
  number: "311",
  label: "MID-SEASON DRAFT",
  href: `${base}standings/draft-mid`,
};
...
export const TRAINERS_PAGE: PageLink = {
  number: "400",
  label: "TRAINERS",
  href: `${base}trainers`,
};
export const GAMES_PAGE: PageLink = {
  number: "500",
  label: "GAMES",
  href: `${base}games`,
};
export const TROPHY_PAGE: PageLink = {
  number: "600",
  label: "TROPHY",
  href: `${base}trophy`,
};
export const AWARDS_PAGE: PageLink = {
  number: "700",
  label: "AWARDS",
  href: `${base}awards`,
};
export const HOMETOWNS_PAGE: PageLink = {
  number: "800",
  label: "HOMETOWNS",
  href: `${base}map`,
};
export const GYM_PAGE: PageLink = {
  number: "888",
  label: "GYM",
  href: `${base}gym`,
};
export const MANAGER_PAGE: PageLink = {
  number: "810",
  label: "MANAGER",
  href: `${base}manager`,
  hidden: true,
...
export const MONS_PAGE: PageLink = {
  number: "901",
  label: "ALL POKEMON - 2ND HALF",
  href: `${base}mons/stats`,
};
export const HELP_PAGE: PageLink = {
  number: "990",
  label: "HELP",
  href: `${base}help`,
};
...
export const MONS_MATCHUP_PAGES: PageLink[] = TRAINER_MATCHUPS.map(
  (matchup) => ({
...
function findPlayerLabel(playerNumber: number): string {
  return (
    PLAYERS.find((player) => player.number === playerNumber)?.name ??
    String(playerNumber)
  );
}
...
export const VISIBLE_PAGES: PageLink[] = ALL_PAGES.filter(
  (page) => !page.hidden,
);
